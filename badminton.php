...
<h3 class="text-2xl font-bold mb-4 text-white text-center">Badminton</h3>
...
<div class="text-center">
    ...
    Hello and Good Afternoon.🏸🏸<br><br>

    Online registration will begin at 2:00PM today. If you are interested to join us, you can register via the provided link or simply by scanning the QR code. 
    Make sure to fill in the details correctly. <br><br>

    First come first serve.
    Successful applicants will be notified through email or WhatsApp.
    All the best.
    </h3>
    <div class="flex justify-center">
